...
const FilterPrices = () => {
  const { alternRadio, firstBoll, setFirstBoolean, setThirth, thirthBoll } =
    useFilterPrice();
    ...
    <ContainerCheckBox>
      ...
      <ContainerInputsLabel>
        <input
          ...
          value="100/200"
          checked={firstBoll}
          onChange={() => alternRadio(setFirstBoolean, setThirth)}
        ></input>
      ...
      <ContainerInputsLabel>
        <input
          ...
          value="500+"
          checked={thirthBoll}
          onChange={() => alternRadio(setThirth, setFirstBoolean)}
        ></input>
