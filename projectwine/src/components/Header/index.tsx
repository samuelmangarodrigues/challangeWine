  ...
  return (
    <ContainerHeader>
      ...
      <ListMenu>
        ...
        <ListItem id="removeItems" onClick={() => history.push("/")}>
          Loja
        </ListItem>
        <ListItem onClick={() => history.push("/")} id="iconWine">
          <IoWine size={31.66} />
        </ListItem>
      ...
      <div>
        <LinkPortfolio
          href="https://samuelmanga-portfolio.vercel.app/"
          target="_blank"
          rel="noreferrer"
        >
        ...
        <ButtonCart onClick={() => history.push("/cart")}>
          ...
          {cart.length === 0 ? (
            ...
            <CartLenghtItems>{cart.length}</CartLenghtItems>
          )}
        </ButtonCart>
      </div>
    </ContainerHeader>
